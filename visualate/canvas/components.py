...
# --------------------------------------------------------------------------- #
# Created       : Wednesday, March 4th 2020, 6:24:58 pm                       #
# Last Modified : Wednesday, March 4th 2020, 6:36:45 pm                       #
# Modified By   : John James (jjames@decisionscients.com>)                    #
# --------------------------------------------------------------------------- #
# License : BSD                                                               #
# Copyright (c) 2020 DecisionScients                                          #
# =========================================================================== #
"""Canvas configuration components.
TODO: Add color template if/where appropriate
...
This module defines classes that encapsulate logical groupings of 
configurable settings. Each class exposes settings as attributes and 
provides methods to apply the configurations to a plotly plot object. 
These concrete component classes are further encapsulated by the
Canvas class.

The module is comprised of the following classes.

    * CanvasComponent : Interface for canvas component classes.
    * Canvas : Composite containing other CanvasComponent subclasses. 
...
class Canvas(CanvasComponent):    
    ...
    def update_layout(self, fig):
        if bool(self._components):
            for component in self._components.values():
                fig = component.update_layout(fig)                
        return fig
    ...
    def add_component(self, component):
        ...
        if self._components[component_name]:
    ...
    def update_component(self, component):
        ...
        if not self._components[component_name]:
            ...
            self._components[component_name].update(parameters)
    ...
    def delete_component(self, component_name=None):
        ...
        if component_name is None:
            ...
            if delete_all in ['Y', 'y', 'Yes', 'yes', 'YES']:
                ...
                self._components[component_name] = dict()
            else:
...
class CanvasTitle(CanvasComponent):
    ...
    def update_layout(self, fig):
        ...
        fig.update_layout(
            title=dict(text=self._parameters['title_text'],
                       font=dict(family=self._parameters['title_font_family'],
                                 size=self._parameters['title_font_size'],
                                 color=self._parameters['title_font_color']),
                       xref=self._parameters['title_xref'],
                       yref=self._parameters['title_yref'],
                       x=self._parameters['title_x'],
                       y=self._parameters['title_y'],
                       xanchor=self._parameters['title_xanchor'],
                       yanchor=self._parameters['title_yanchor'],
                       pd=self._parameters['title_pad']))
    ...
    def title_text(self):
        ...
        return self._parameters['title_text']

    @title_text.setter
    def title_text(self, value):
        """Sets the title_text attribute."""
        self._parameters['title_text'] = value
    ...
    def title_xref(self):
        ...
        only.
        """
        return self._parameters['title_xref']
    ...
    def title_xref(self, value):
        ...
        if value in valid_values:
            self._parameters['title_xref'] = value                
        else:
    ...
    def title_yref(self):
        ...
        only.
        """
        return self._parameters['title_yref']
    ...
    def title_yref(self, value):
        ...
        valid_values = ['container', 'paper']
        if value in valid_values:
            self._parameters['title_yref'] = value                
        else:
    ...
    def title_x(self):
        ...
        """
        return self._parameters['title_x']
    ...
    def title_x(self, value):
        ...
        if value >= 0 and value <= 1:
            self._parameters['title_x'] = value                
        else:
    ...
    def title_y(self):
        ...
        return self._parameters['title_y']
    ...
    def title_y(self, value):
        ...
        if isinstance(value, str):
            if value == 'auto':
                self._parameters['title_y'] = value
            else:
    ...
    def title_xanchor(self):
        ...
        return self._parameters['title_xanchor']
    ...
    def title_xanchor(self, value):
        ...
        if value in valid_values:
            self._parameters['title_xanchor'] = value                
        else:
    ...
    def title_yanchor(self):
        ...
        return self._parameters['title_yanchor']
    ...
    def title_yanchor(self, value):
        ...
        if value in valid_values:
            self._parameters['title_yanchor'] = value                
        else:
    ...
    def title_pad(self):
        ...
        return self._parameters['title_pad']
        ...
        if isinstance(value, dict):
            if all(item in valid_keys for item in value.keys()):
                if all(isinstance(v,int) for v in value.values()):
                    self._parameters['title_pad'] = value
                else:
...
class CanvasLegend(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['legend_show'] = True
        self._parameters['legend_bgcolor'] = None   
        self._parameters['legend_bordercolor'] = '#444'
        self._parameters['legend_borderwidth'] = 0
        self._parameters['legend_font_family'] = None
        self._parameters['legend_font_size'] = None
        self._parameters['legend_font_color'] = None
        self._parameters['legend_orientation'] = 'v'
        self._parameters['legend_itemsizing'] = 'trace'
        self._parameters['legend_itemclick'] = 'toggle'
        self._parameters['legend_x'] = 1.02
        self._parameters['legend_y'] = 1
        self._parameters['legend_xanchor'] = 'left'
        self._parameters['legend_yanchor'] = 'auto'
        self._parameters['legend_valign'] = 'middle'

    def reset(self):
        self._parameters = {}
        self._parameters['legend_show'] = self.DEFAULTS['show']
        self._parameters['legend_bgcolor'] = self.DEFAULTS['bgcolor']
        self._parameters['legend_bordercolor'] = self.DEFAULTS['bordercolor']
        self._parameters['legend_borderwidth'] = self.DEFAULTS['borderwidth']
        self._parameters['legend_font_family'] = self.DEFAULTS['font_family']
        self._parameters['legend_font_size'] = self.DEFAULTS['font_size']
        self._parameters['legend_font_color'] = self.DEFAULTS['font_color']
        self._parameters['legend_orientation'] = self.DEFAULTS['orientation']
        self._parameters['legend_itemsizing'] = self.DEFAULTS['itemsizing']
        self._parameters['legend_itemclick'] = self.DEFAULTS['itemclick']
        self._parameters['legend_x'] = self.DEFAULTS['x']
        self._parameters['legend_y'] = self.DEFAULTS['y']
        self._parameters['legend_xanchor'] = self.DEFAULTS['xanchor']
        self._parameters['legend_yanchor'] = self.DEFAULTS['yanchor']
        self._parameters['legend_valign'] = self.DEFAULTS['valign']
    ...
    def update_layout(self, fig):
        ...
        fig.update_layout(
            showlegend=self._parameters['legend_show'],
            legend=dict(bgcolor=self._parameters['legend_bgcolor'],
                        bordercolor=self._parameters['legend_bordercolor'],
                        borderwidth=self._parameters['legend_borderwidth'],
                        font=dict(family=self._parameters['legend_font_family'],
                                  size=self._parameters['legend_font_size'],
                                  color=self._parameters['legend_font_color']),
                        orientation=self._parameters['legend_orientation'],
                        itemsizing=self._parameters['legend_itemsizing'],
                        itemclick=self._parameters['legend_itemclick'],
                        x=self._parameters['legend_x'],
                        y=self._parameters['legend_y'],
                        xanchor=self._parameters['legend_xanchor'],
                        yanchor=self._parameters['legend_yanchor'],
                        valign=self._parameters['legend_valign']))
    ...
    def legend_show(self):
        ...
        return self._parameters['legend_show']

    @legend_show.setter
    def legend_show(self, value):
        """Sets the legend_show attribute."""
        if isinstance(value, bool):
            self._parameters['legend_show'] = value        
        else:
    ...
    def legend_orientation(self):
        ...
        return self._parameters['legend_orientation']
    ...
    def legend_orientation(self, value):
        ...
        valid_values = ['v', 'h']
        if value in valid_values:
            self._parameters['legend_orientation'] = value             
        else:
    ...
    def legend_itemsizing(self):
        ...
        return self._parameters['legend_itemsizing']
    ...
    def legend_itemsizing(self, value):
        ...
        if value in valid_values:
            self._parameters['legend_itemsizing'] = value               
        else:
    ...
    def legend_itemclick(self):
        ...
        return self._parameters['legend_itemclick']
    ...
    def legend_itemclick(self, value):
        ...
        if value in valid_values:
            self._parameters['legend_itemclick'] = value                       
        else:
    ...
    def legend_x(self):
        ...
        coordinates from '0' (left) to '1' (right)
        """
        return self._parameters['legend_x']
    ...
    def legend_x(self, value):
        ...
        if isinstance(value,(int, float)) and value >= -2 and value <= 3:
            self._parameters['legend_x'] = value                
    ...
    def legend_y(self):
        ...
        return self._parameters['legend_y']
    ...
    def legend_y(self, value):
        ...
        if isinstance(value,(int, float)) and value >= -2 and value <= 3:
            self._parameters['legend_y'] = value                
        elif not isinstance(value, (int, float)):
    ...
    def legend_xanchor(self):
        ...
        return self._parameters['legend_xanchor']
    ...
    def legend_xanchor(self, value):
        ...
        valid_values = ['auto', 'left', 'center', 'right']        
        if value in valid_values:
            self._parameters['legend_xanchor'] = value                
        else:
            raise ValueError("xanchor must be 'auto', 'left', 'center',\
                             or 'right'.")             
    ...
    def legend_yanchor(self):
        ...
        return self._parameters['legend_yanchor']
    ...
    def legend_yanchor(self, value):
        ...
        valid_values = ['auto', 'top', 'middle', 'bottom']        
        if value in valid_values:
            self._parameters['legend_yanchor'] = value                
        else:
            raise ValueError("yanchor must be 'auto', 'top', 'middle',\
                             or 'bottom'.")               
    ...
    def legend_valign(self):
        ...
        return self._parameters['legend_valign']
    ...
    def legend_valign(self, value):
        ...
        if value in valid_values:
            self._parameters['legend_valign'] = value                
        else:
...
class CanvasMargins(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['margins_left'] = 80
        self._parameters['margins_top'] = 100   
        self._parameters['margins_bottom'] = 80
        self._parameters['margins_pad'] = 0

    def reset(self):
        self._parameters = {}
        self._parameters['margins_left'] = self.DEFAULTS['left']
        self._parameters['margins_top'] = self.DEFAULTS['top']   
        self._parameters['margins_bottom'] = self.DEFAULTS['bottom']
        self._parameters['margins_pad'] = self.DEFAULTS['pad']
    ...
    def update_layout(self, fig):
        ...
        fig.update_layout(
            margin=dict(l=self._parameters['margins_left'],
                        t=self._parameters['margins_top'],
                        b=self._parameters['margins_bottom'],
                        pad=self._parameters['margins_pad'])
        )
    ...
    def margins_left(self):
        ...
        return self._parameters['margins_left']

    @margins_left.setter
    def margins_left(self, value):
        """Sets the margins_left attribute."""
        if isinstance(value,int) and value >= 0:
            self._parameters['margins_left'] = value        
        else:
            raise ValueError("value must be an integer >= 0")
    ...
    def margins_top(self):
        ...
        return self._parameters['margins_top']

    @margins_top.setter
    def margins_top(self, value):
        """Sets the margins_top attribute."""
        if isinstance(value,int) and value >= 0:
            self._parameters['margins_top'] = value        
        else:
            raise ValueError("value must be an integer >= 0")      
    ...
    def margins_pad(self):
        ...
        return self._parameters['margins_pad']

    @margins_pad.setter
    def margins_pad(self, value):
        """Sets the margins_pad attribute."""
        if isinstance(value,int) and value >= 0:
            self._parameters['margins_pad'] = value        
        else:
            raise ValueError("value must be an integer >= 0")             
...
class CanvasSize(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['size_autosize'] = True
        self._parameters['size_width'] = 700   
        self._parameters['size_height'] = 450

    def reset(self):
        self._parameters = {}
        self._parameters['size_autosize'] = self.DEFAULTS['autosize']
        self._parameters['size_width'] = self.DEFAULTS['width']   
        self._parameters['size_height'] = self.DEFAULTS['height']
    ...
    def update_layout(self, fig):
        ...
        fig.update_layout(
            size=self._parameters['size_autosize'],
            width=self._parameters['size_width'],
            height=self._parameters['size_height']
        )
    ...
    def size_autosize(self):
        ...
        return self._parameters['size_autosize']
    ...
    def size_autosize(self, value):
        ...
        if isinstance(value, bool):
            self._parameters['size_autosize'] = value        
        else:
    ...
    def size_height(self):
        ...
        return self._parameters['size_height']

    @size_height.setter
    def size_height(self, value):
        """Sets the size_height attribute."""
        if isinstance(value, (int, float)) and value >= 10:
            self._parameters['size_height'] = value        
        else:
...
class CanvasFont(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['font_family'] = None
        self._parameters['font_size'] = 12   
        self._parameters['font_color'] = '#444'
        self._parameters['font_separators'] = '.,'

    def reset(self):
        self._parameters = {}
        self._parameters['font_family'] = self.DEFAULTS['family']
        self._parameters['font_size'] = self.DEFAULTS['size']   
        self._parameters['font_color'] = self.DEFAULTS['color']
        self._parameters['font_separators'] = self.DEFAULTS['separators']
    ...
    def update_layout(self, fig):
        ...
        fig.update_layout(
            font=dict(
                family=self._parameters['font_family'],
                size=self._parameters['font_size'],
                color=self._parameters['font_color']),
            separators=self._parameters['font_separators']
        )
    ...
    def font_family(self):
        ...
        return self._parameters['font_family']

    @font_family.setter
    def font_family(self, value):
        """Sets the font_family attribute."""
        self._parameters['font_family'] = value              
    ...
    def font_size(self):
        ...
        return self._parameters['font_size']

    @font_size.setter
    def font_size(self, value):
        """Sets the font_size attribute."""
        if isinstance(value, int) and value >= 1:
            self._parameters['font_size'] = value              
        else:
    ...
    def font_color(self):
        ...
        return self._parameters['font_color']

    @font_color.setter
    def font_color(self, value):
        """Sets the font_color attribute."""
        self._parameters['font_color'] = value                  
    ...
    def font_separators(self):
        ...
        between thousands.
        """
        return self._parameters['font_separators']
    ...
    def font_separators(self, value):
        ...
        self._parameters['font_separators'] = value            
...
class CanvasColorBackground(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['paper_bgcolor'] = '#fff'
        self._parameters['plot_bgcolor'] = '#fff'   

    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['paper_bgcolor'] = self.DEFAULTS["paper_bgcolor"]
        self._parameters['plot_bgcolor'] = self.DEFAULTS["plot_bgcolor"]      

    # ----------------------------------------------------------------------- #
    #                              UPDATE LAYOUT                              #
    # ----------------------------------------------------------------------- #
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorBackground self._parameters['
        ...
        fig.update_layout(
            paper_bgcolor=self._parameters['paper_bgcolor'],
            plot_bgcolor=self._parameters['plot_bgcolor']
        )
    ...
    def paper_bgcolor(self):
        ...
        return self._parameters['paper_bgcolor']
    ...
    def paper_bgcolor(self, value):
        ...
        value : str, Default = '#fff'
            Sets the color of paper where the graph is drawn.
        """
        self._parameters['paper_bgcolor'] = value                      
    ...
    def plot_bgcolor(self):
        ...
        return self._parameters['plot_bgcolor']
    ...
    def plot_bgcolor(self, value):
        ...
        value : str, Default = '#fff'
            Sets the color of plot where the graph is drawn.
        """
        self._parameters['plot_bgcolor'] = value              
...
class CanvasColorScale(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['colorscale_sequential'] = [[0, 'rgb(220,220,220)'], [0.2, 'rgb(245,195,157)'], 
                                  [0.4, 'rgb(245,160,105)'], [1, 'rgb(178,10,28)'], ]
        self._parameters['colorscale_sequentialminus'] = [[0, 'rgb(5,10,172)'], 
                                        [0.35, 'rgb(40,60,190)'], 
                                        [0.5, 'rgb(70,100,245)'], 
                                        [0.6, 'rgb(90,120,245)'], 
                                        [0.7, 'rgb(106,137,247)'], 
                                        [1, 'rgb(220,220,220)'], ]
        self._parameters['colorscale_diverging'] = [[0, 'rgb(5,10,172)'], [0.35, 'rgb(106,137,247)'], 
                                [0.5, 'rgb(190,190,190)'], [0.6, 'rgb(220,170,132)'], 
                                [0.7, 'rgb(230,145,90)'], [1, 'rgb(178,10,28)'], ]
        self._parameters['colorway'] = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', 
                      '#8c564b', '#e377c2', '#7f7f7f', '#bcbd22', '#17becf']

    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['colorscale_sequential'] = self.DEFAULTS["colorscale_sequential"]
        self._parameters['colorscale_sequentialminus'] = self.DEFAULTS["colorscale_sequentialminus"]
        self._parameters['colorscale_diverging'] = self.DEFAULTS["colorscale_diverging"]
        self._parameters['colorway'] = self.DEFAULTS["colorway"]

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- #
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorScale self._parameters['
        ...
        fig.update_layout(
            colorscale=dict(
                sequential=self._parameters['colorscale_sequential'],
                sequentialminus=self._parameters['colorscale_sequentialminus'],
                diverging=self._parameters['colorscale_diverging']),
            colorway=self._parameters['colorway']
        )
    ...
    def colorscale_sequential(self):
        ...
        return self._parameters['colorscale_sequential']
    ...
    def colorscale_sequential(self, value):
        ...
        value : list Default = [[0, rgb(220,220,220)], [0.2, rgb(245,195,157)], 
            ...
            Sets the default sequential colorscale for positive values. 
        """
        self._parameters['colorscale_sequential'] = value                   
    ...
    def colorscale_sequentialminus(self):
        ...
        return self._parameters['colorscale_sequentialminus']
    ...
    def colorscale_sequentialminus(self, value):
        ...
        value : list Default = [[0, rgb(5,10,172)], 
            ...
            Sets the default sequential colorscale for negative values. 
        """
        self._parameters['colorscale_sequentialminus'] = value                           
    ...
    def colorscale_diverging(self):
        ...
        return self._parameters['colorscale_diverging']
    ...
    def colorscale_diverging(self, value):
        ...
        value : list, Default = [[0, rgb(5,10,172)], [0.35, rgb(106,137,247)], 
            ...
            Sets the default diverging colorscale.
        """
        self._parameters['colorscale_diverging'] = value                           
    ...
    def colorway(self):
        ...
        return self._parameters['colorway']
    ...
    def colorway(self, value):
        ...
        value : list. Default = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', 
            ...
            Sets the default trace colors.
        """
        self._parameters['colorway'] = value     
...
class CanvasColorAxisDomain(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['coloraxis_cauto'] = True
        self._parameters['coloraxis_cmin'] = None
        self._parameters['coloraxis_cmax'] = None
        self._parameters['coloraxis_cmid'] = None


    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['coloraxis_cauto'] = self.DEFAULTS["coloraxis_cauto"]
        self._parameters['coloraxis_cmin'] = self.DEFAULTS["coloraxis_cmin"]
        self._parameters['coloraxis_cmax'] = self.DEFAULTS["coloraxis_cmax"]
        self._parameters['coloraxis_cmid'] = self.DEFAULTS["coloraxis_cmid"]

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- #
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorAxisDomain self._parameters['
        ...
        fig.update_layout(
            coloraxis=dict(
                cauto=self._parameters['coloraxis_cauto'],
                cmin=self._parameters['coloraxis_cmin'],
                cmax=self._parameters['coloraxis_cmax'],
                cmid=self._parameters['coloraxis_cmid'])
        )
    ...
    def coloraxis_cauto(self):
        ...
        return self._parameters['coloraxis_cauto']
    ...
    def coloraxis_cauto(self, value):
        ...
        """
        if isinstance(value, bool):
            self._parameters['coloraxis_cauto'] = value         
        else:
    ...
    def coloraxis_cmin(self):
        ...
        return self._parameters['coloraxis_cmin']
    ...
    def coloraxis_cmin(self, value):
        ...
        if isinstance(value, (float, int)):
            self._parameters['coloraxis_cmin'] = value                 
        else:
    ...
    def coloraxis_cmax(self):
        ...
        return self._parameters['coloraxis_cmax']
    ...
    def coloraxis_cmax(self, value):
        ...
        if isinstance(value, (float, int)):
            self._parameters['coloraxis_cmax'] = value                 
        else:
            raise TypeError("value must be a number")         
    ...
    def coloraxis_cmid(self):
        ...
        return self._parameters['coloraxis_cmid']
    ...
    def coloraxis_cmid(self, value):
        ...
        if isinstance(value, (float, int)):
            self._parameters['coloraxis_cmid'] = value                 
        else:
            raise TypeError("value must be a number")       
...
class CanvasColorAxisScales(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['coloraxis_colorscale'] = [[0, 'rgb(0,0,255)'], [1, 'rgb(255,0,0)']]
        self._parameters['coloraxis_autoscale'] = True
        self._parameters['coloraxis_reversescale'] = True
        self._parameters['coloraxis_showscale'] = True

    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['coloraxis_colorscale'] = self.DEFAULTS["coloraxis_colorscale"]
        self._parameters['coloraxis_autoscale'] = self.DEFAULTS["coloraxis_autoscale"]
        self._parameters['coloraxis_reversescale'] = self.DEFAULTS["coloraxis_reversescale"]
        self._parameters['coloraxis_showscale'] = self.DEFAULTS["coloraxis_showscale"]

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- #
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorAxisScales self._parameters['
        ...
        fig.update_layout(
            coloraxis=dict(
                colorscale=self._parameters['coloraxis_colorscale'],
                autocolorscale=self._parameters['coloraxis_autoscale'],
                reversescale=self._parameters['coloraxis_reversescale'],
                showscale=self._parameters['coloraxis_showscale'])
        )
    ...
    def coloraxis_colorscale(self):
        ...
        return self._parameters['coloraxis_colorscale']
    ...
    def coloraxis_colorscale(self, value):
        ...
        if isinstance(value, list):
            self._parameters['coloraxis_colorscale'] = value                
        else:
    ...
    def coloraxis_autoscale(self):
        ...
        return self._parameters['coloraxis_autoscale']
    ...
    def coloraxis_autoscale(self, value):
        ...
        """
        if isinstance(value, bool):
            self._parameters['coloraxis_autoscale'] = value                  
        else:
            raise TypeError("value must be boolean True or False.")
    ...
    def coloraxis_reversescale(self):
        ...
        return self._parameters['coloraxis_reversescale']
    ...
    def coloraxis_reversescale(self, value):
        ...
        if isinstance(value, bool):
            self._parameters['coloraxis_reversescale'] = value                  
        else:
            raise TypeError("value must be boolean True or False.")             
    ...
    def coloraxis_showscale(self):
        ...
        return self._parameters['coloraxis_showscale']
    ...
    def coloraxis_showscale(self, value):
        ...
        if isinstance(value, bool):
            self._parameters['coloraxis_showscale'] = value                  
        else:
            raise TypeError("value must be boolean True or False.")    
...
class CanvasColorAxisBarStyle(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['coloraxis_colorbar_thicknessmode'] = 'pixels'
        self._parameters['coloraxis_colorbar_thickness'] = 30
        self._parameters['coloraxis_colorbar_lenmode'] = 'fraction'
        self._parameters['coloraxis_colorbar_len'] = 1
        self._parameters['coloraxis_colorbar_bgcolor'] = "rgba(0,0,0,0)"


    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['coloraxis_colorbar_thicknessmode'] = self.DEFAULTS["coloraxis_colorbar_thicknessmode"]
        self._parameters['coloraxis_colorbar_thickness'] = self.DEFAULTS["coloraxis_colorbar_thickness"]
        self._parameters['coloraxis_colorbar_lenmode'] = self.DEFAULTS["coloraxis_colorbar_lenmode"]
        self._parameters['coloraxis_colorbar_len'] = self.DEFAULTS["coloraxis_colorbar_len"]
        self._parameters['coloraxis_colorbar_bgcolor'] = self.DEFAULTS["coloraxis_colorbar_bgcolor"]

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- #
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorAxisBarStyle self._parameters['
        ...
        fig.update_layout(
            coloraxis=dict(
                colorbar=dict(
                    thicknessmode=self._parameters['coloraxis_colorbar_thicknessmode'],
                    thickness=self._parameters['coloraxis_colorbar_thickness'],
                    lenmode=self._parameters['coloraxis_colorbar_lenmode'],
                    len=self._parameters['coloraxis_colorbar_len'],
                    bgcolor=self._parameters['coloraxis_colorbar_bgcolor']
                )
            )
        )
    ...
    def coloraxis_colorbar_thicknessmode(self):
        ...
        return self._parameters['coloraxis_colorbar_thicknessmode']
    ...
    def coloraxis_colorbar_thicknessmode(self, value):
        ...
        if value in valid_values:
            self._parameters['coloraxis_colorbar_thicknessmode'] = value              
        else:
    ...
    def coloraxis_colorbar_thickness(self):
        ...
        return self._parameters['coloraxis_colorbar_thickness']
    ...
    def coloraxis_colorbar_thickness(self, value):
        ...
        if isinstance(value, (int, float)) and value >= 0:
            self._parameters['coloraxis_colorbar_thickness'] = value              
        else:
    ...
    def coloraxis_colorbar_lenmode(self):
        ...
        return self._parameters['coloraxis_colorbar_lenmode']
    ...
    def coloraxis_colorbar_lenmode(self, value):
        ...
        valid_values = ['fraction', 'pixels']
        if value in valid_values:
            self._parameters['coloraxis_colorbar_lenmode'] = value         
        else:
    ...
    def coloraxis_colorbar_len(self):
        ...
        return self._parameters['coloraxis_colorbar_len']
    ...
    def coloraxis_colorbar_len(self, value):
        ...
        if isinstance(value, (int, float)) and value >= 0:
            self._parameters['coloraxis_colorbar_len'] = value                        
        else:
    ...
    def coloraxis_colorbar_bgcolor(self):
        ...
        return self._parameters['coloraxis_colorbar_bgcolor']
    ...
    def coloraxis_colorbar_bgcolor(self, value):
        ...
        """
        if isinstance(value, str):
            self._parameters['coloraxis_colorbar_bgcolor'] = value               
        else:
...
class CanvasColorAxisBarPosition(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['coloraxis_colorbar_x'] = 1.02
        self._parameters['coloraxis_colorbar_y'] = 0.5
        self._parameters['coloraxis_colorbar_xanchor'] = 'left'
        self._parameters['coloraxis_colorbar_yanchor'] = 'middle'
        self._parameters['coloraxis_colorbar_xpad'] = 10
        self._parameters['coloraxis_colorbar_ypad'] = 10        

    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['coloraxis_colorbar_x'] = self.DEFAULTS["coloraxis_colorbar_x"]
        self._parameters['coloraxis_colorbar_y'] = self.DEFAULTS["coloraxis_colorbar_y"]
        self._parameters['coloraxis_colorbar_xanchor'] = self.DEFAULTS["coloraxis_colorbar_xanchor"]
        self._parameters['coloraxis_colorbar_yanchor'] = self.DEFAULTS["coloraxis_colorbar_yanchor"]
        self._parameters['coloraxis_colorbar_xpad'] = self.DEFAULTS["coloraxis_colorbar_xpad"]
        self._parameters['coloraxis_colorbar_ypad'] = self.DEFAULTS["coloraxis_colorbar_ypad"]

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- #        
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorAxisBarPosition self._parameters['
        ...
        fig.update_layout(
            coloraxis=dict(
                colorbar=dict(
                    x=self._parameters['coloraxis_colorbar_x'],
                    y=self._parameters['coloraxis_colorbar_y'],
                    xanchor=self._parameters['coloraxis_colorbar_xanchor'],
                    yanchor=self._parameters['coloraxis_colorbar_yanchor'],
                    xpad=self._parameters['coloraxis_colorbar_xpad'],
                    ypad=self._parameters['coloraxis_colorbar_ypad']
                )
            )
        )
    ...
    def coloraxis_colorbar_x(self):
        ...
        return self._parameters['coloraxis_colorbar_x']
    ...
    def coloraxis_colorbar_x(self, value):
        ...
        if isinstance(value, (int, float)) and value >= -2 and value <= 3:
            self._parameters['coloraxis_colorbar_x'] = value                 
        else:
    ...
    def coloraxis_colorbar_y(self):
        ...
        return self._parameters['coloraxis_colorbar_y']
    ...
    def coloraxis_colorbar_y(self, value):
        ...
        """
        if isinstance(value, (int, float)) and value >= -2 and value <= 3:
            self._parameters['coloraxis_colorbar_y'] = value                 
        else:
    ...
    def coloraxis_colorbar_xanchor(self):
        ...
        return self._parameters['coloraxis_colorbar_xanchor']
    ...
    def coloraxis_colorbar_xanchor(self, value):
        ...
        if value in valid_values:            
            self._parameters['coloraxis_colorbar_xanchor'] = value          
        else:
    ...
    def coloraxis_colorbar_yanchor(self):
        ...
        return self._parameters['coloraxis_colorbar_yanchor']
    ...
    def coloraxis_colorbar_yanchor(self, value):
        ...
        if value in valid_values:            
            self._parameters['coloraxis_colorbar_yanchor'] = value               
        else:
    ...
    def coloraxis_colorbar_xpad(self):
        ...
        return self._parameters['coloraxis_colorbar_xpad']
    ...
    def coloraxis_colorbar_xpad(self, value):
        ...
        if isinstance(value, (int, float)) and value >= 0:
            self._parameters['coloraxis_colorbar_xpad'] = value                    
        else:
    ...
    def coloraxis_colorbar_ypad(self):
        ...
        return self._parameters['coloraxis_colorbar_ypad']
    ...
    def coloraxis_colorbar_ypad(self, value):
        ...
        """
        if isinstance(value, (int, float)) and value >= 0:
            self._parameters['coloraxis_colorbar_ypad'] = value                    
        else:
...
class CanvasColorAxisBarBoundary(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['coloraxis_colorbar_outlinecolor'] = '#444'        
        self._parameters['coloraxis_colorbar_outlinewidth'] = 1        
        self._parameters['coloraxis_colorbar_bordercolor'] = '#444'        
        self._parameters['coloraxis_colorbar_borderwidth'] = 0        

    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['coloraxis_colorbar_outlinecolor'] = self.DEFAULTS["coloraxis_colorbar_outlinecolor"]
        self._parameters['coloraxis_colorbar_outlinewidth'] = self.DEFAULTS["coloraxis_colorbar_outlinewidth"]
        self._parameters['coloraxis_colorbar_bordercolor'] = self.DEFAULTS["coloraxis_colorbar_bordercolor"]
        self._parameters['coloraxis_colorbar_borderwidth'] = self.DEFAULTS["coloraxis_colorbar_borderwidth"]

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- #    
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorAxisBarBoundary self._parameters['
        ...
        fig.update_layout(
            coloraxis=dict(
                colorbar=dict(
                    outlinecolor=self._parameters['coloraxis_colorbar_outlinecolor'],
                    outlinewidth=self._parameters['coloraxis_colorbar_outlinewidth'],
                    bordercolor=self._parameters['coloraxis_colorbar_bordercolor'],
                    borderwidth=self._parameters['coloraxis_colorbar_borderwidth']
                )
            )
        )
    ...
    def coloraxis_colorbar_outlinecolor(self):
        ...
        return self._parameters['coloraxis_colorbar_outlinecolor']
    ...
    def coloraxis_colorbar_outlinecolor(self, value):
        ...
        """
        if isinstance(value, str):
            self._parameters['coloraxis_colorbar_outlinecolor'] = value       
        else:
            raise TypeError("value must be a string.")
    ...
    def coloraxis_colorbar_outlinewidth(self):
        ...
        return self._parameters['coloraxis_colorbar_outlinewidth']
    ...
    def coloraxis_colorbar_outlinewidth(self, value):
        ...
        if isinstance(value, (int, float)) and value >= 0:
            self._parameters['coloraxis_colorbar_outlinewidth'] = value                    
        else:
    ...
    def coloraxis_colorbar_bordercolor(self):
        ...
        return self._parameters['coloraxis_colorbar_bordercolor']
    ...
    def coloraxis_colorbar_bordercolor(self, value):
        ...
        if isinstance(value, str):
            self._parameters['coloraxis_colorbar_bordercolor'] = value       
        else:
            raise TypeError("value must be a string.")
    ...
    def coloraxis_colorbar_borderwidth(self):
        ...
        return self._parameters['coloraxis_colorbar_borderwidth']
    ...
    def coloraxis_colorbar_borderwidth(self, value):
        ...
        if isinstance(value, (int, float)) and value >= 0:
            self._parameters['coloraxis_colorbar_borderwidth'] = value                    
        else:
...
class CanvasColorAxisBarTicks(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['coloraxis_colorbar_tickmode'] = "array"
        self._parameters['coloraxis_colorbar_nticks'] = 0
        self._parameters['coloraxis_colorbar_tick0'] = None
        self._parameters['coloraxis_colorbar_dtick'] = None
        self._parameters['coloraxis_colorbar_tickvals'] = None
        self._parameters['coloraxis_colorbar_ticktext'] = [""]
        self._parameters['coloraxis_colorbar_ticks'] = None


    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['coloraxis_colorbar_tickmode'] = self.DEFAULTS["coloraxis_colorbar_tickmode"]
        self._parameters['coloraxis_colorbar_nticks'] = self.DEFAULTS["coloraxis_colorbar_nticks"]
        self._parameters['coloraxis_colorbar_tick0'] = self.DEFAULTS["coloraxis_colorbar_tick0"]
        self._parameters['coloraxis_colorbar_dtick'] = self.DEFAULTS["coloraxis_colorbar_dtick"]
        self._parameters['coloraxis_colorbar_tickvals'] = self.DEFAULTS["coloraxis_colorbar_tickvals"]
        self._parameters['coloraxis_colorbar_ticktext'] = self.DEFAULTS["coloraxis_colorbar_ticktext"]
        self._parameters['coloraxis_colorbar_ticks'] = self.DEFAULTS["coloraxis_colorbar_ticks"]

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- #    
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorAxisBarTicks self._parameters['
        ...
        fig.update_layout(
            coloraxis=dict(
                colorbar=dict(
                    tickmode=self._parameters['coloraxis_colorbar_tickmode'],
                    nticks=self._parameters['coloraxis_colorbar_nticks'],
                    tick0=self._parameters['coloraxis_colorbar_tick0'],
                    dtick=self._parameters['coloraxis_colorbar_dtick'],
                    tickvals=self._parameters['coloraxis_colorbar_tickvals'],
                    ticktext=self._parameters['coloraxis_colorbar_ticktext'],
                    ticks=self._parameters['coloraxis_colorbar_ticks']
                )
            )
        )
    ...
    def coloraxis_colorbar_tickmode(self):
        ...
        return self._parameters['coloraxis_colorbar_tickmode']
    ...
    def coloraxis_colorbar_tickmode(self, value):
        ...
        if value in valid_values:
            self._parameters['coloraxis_colorbar_tickmode'] = value        
        else:
    ...
    def coloraxis_colorbar_nticks(self):
        ...
        return self._parameters['coloraxis_colorbar_nticks']
    ...
    def coloraxis_colorbar_nticks(self, value):
        ...
        if isinstance(value, (int, float)) and value >= 0:
            self._parameters['coloraxis_colorbar_nticks'] = value                      
        else:
    ...
    def coloraxis_colorbar_tick0(self):
        ...
        return self._parameters['coloraxis_colorbar_tick0']
    ...
    def coloraxis_colorbar_tick0(self, value):
        ...
        self._parameters['coloraxis_colorbar_tick0'] = value           
    ...
    def coloraxis_colorbar_dtick(self):
        ...
        return self._parameters['coloraxis_colorbar_dtick']
    ...
    def coloraxis_colorbar_dtick(self, value):
        ...
        self._parameters['coloraxis_colorbar_dtick'] = value                             
    ...
    def coloraxis_colorbar_tickvals(self):
        ...
        return self._parameters['coloraxis_colorbar_tickvals']
    ...
    def coloraxis_colorbar_tickvals(self, value):
        ...
        self._parameters['coloraxis_colorbar_tickvals'] = value         
    ...
    def coloraxis_colorbar_ticktext(self):
        ...
        return self._parameters['coloraxis_colorbar_ticktext']
    ...
    def coloraxis_colorbar_ticktext(self, value):
        ...
        if isinstance(value, (pd.Series, np.ndarray, list, tuple)):
            self._parameters['coloraxis_colorbar_ticktext'] = value         
        else:
    ...
    def coloraxis_colorbar_ticks(self):
        ...
        return self._parameters['coloraxis_colorbar_ticks']
    ...
    def coloraxis_colorbar_ticks(self, value):
        ...
        if value in valid_values:
            self._parameters['coloraxis_colorbar_ticks'] = value                 
        else:
...
class CanvasColorAxisBarTickStyle(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['coloraxis_colorbar_ticklen'] = 5
        self._parameters['coloraxis_colorbar_tickwidth'] = 1
        self._parameters['coloraxis_colorbar_tickcolor'] = '#444'
        self._parameters['coloraxis_colorbar_showticklabels'] = True
        self._parameters['coloraxis_colorbar_tickangle'] = ""
        self._parameters['coloraxis_colorbar_tickprefix'] = ''
        self._parameters['coloraxis_colorbar_showtickprefix'] = 'all'
        self._parameters['coloraxis_colorbar_ticksuffix'] = ''
        self._parameters['coloraxis_colorbar_showticksuffix'] = 'all'
    ...
    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['coloraxis_colorbar_ticklen'] = self.DEFAULTS["coloraxis_colorbar_ticklen"]
        self._parameters['coloraxis_colorbar_tickwidth'] = self.DEFAULTS["coloraxis_colorbar_tickwidth"]
        self._parameters['coloraxis_colorbar_tickcolor'] = self.DEFAULTS["coloraxis_colorbar_tickcolor"]
        self._parameters['coloraxis_colorbar_showticklabels'] = self.DEFAULTS["coloraxis_colorbar_showticklabels"]
        self._parameters['coloraxis_colorbar_tickangle'] = self.DEFAULTS["coloraxis_colorbar_tickangle"]
        self._parameters['coloraxis_colorbar_tickprefix'] = self.DEFAULTS["coloraxis_colorbar_tickprefix"]
        self._parameters['coloraxis_colorbar_showtickprefix'] = self.DEFAULTS["coloraxis_colorbar_showtickprefix"]
        self._parameters['coloraxis_colorbar_ticksuffix'] = self.DEFAULTS["coloraxis_colorbar_ticksuffix"]
        self._parameters['coloraxis_colorbar_showticksuffix'] = self.DEFAULTS["coloraxis_colorbar_showticksuffix"]

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- # 
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorAxisBarTickStyle self._parameters['
        ...
        fig.update_layout(
            coloraxis=dict(
                colorbar=dict(
                    ticklen=self._parameters['coloraxis_colorbar_ticklen'],
                    tickwidth=self._parameters['coloraxis_colorbar_tickwidth'],
                    tickcolor=self._parameters['coloraxis_colorbar_tickcolor'],
                    showticklabels=self._parameters['coloraxis_colorbar_showticklabels'],
                    tickangle=self._parameters['coloraxis_colorbar_tickangle'],
                    tickprefix=self._parameters['coloraxis_colorbar_tickprefix'],
                    showtickprefix=self._parameters['coloraxis_colorbar_showtickprefix'],
                    ticksuffix=self._parameters['coloraxis_colorbar_ticksuffix'],
                    showticksuffix=self._parameters['coloraxis_colorbar_showticksuffix']
                )
            )
        )
    ...
    def coloraxis_colorbar_ticklen(self):
        ...
        return self._parameters['coloraxis_colorbar_ticklen']
    ...
    def coloraxis_colorbar_ticklen(self, value):
        ...
        if isinstance(value, int) and value >= 0:
            self._parameters['coloraxis_colorbar_ticklen'] = value                 
        else:
    ...
    def coloraxis_colorbar_tickwidth(self):
        ...
        return self._parameters['coloraxis_colorbar_tickwidth']
    ...
    def coloraxis_colorbar_tickwidth(self, value):
        ...
        if isinstance(value, int) and value >= 0:
            self._parameters['coloraxis_colorbar_tickwidth'] = value                 
        else:
    ...
    def coloraxis_colorbar_tickcolor(self):
        ...
        return self._parameters['coloraxis_colorbar_tickcolor']
    ...
    def coloraxis_colorbar_tickcolor(self, value):
        ...
        self._parameters['coloraxis_colorbar_tickcolor'] = value                 
    ...
    def coloraxis_colorbar_showticklabels(self):
        ...
        return self._parameters['coloraxis_colorbar_showticklabels']
    ...
    def coloraxis_colorbar_showticklabels(self, value):
        ...
        """                
        if isinstance(value, bool):
            self._parameters['coloraxis_colorbar_showticklabels'] = value                 
        else:
    ...
    def coloraxis_colorbar_tickangle(self):
        ...
        return self._parameters['coloraxis_colorbar_tickangle']
    ...
    def coloraxis_colorbar_tickangle(self, value):
        ...
        """                
        if isinstance(value, (float, int)):
            self._parameters['coloraxis_colorbar_tickangle'] = value             
        else:
    ...
    def coloraxis_colorbar_tickprefix(self):
        ...
        return self._parameters['coloraxis_colorbar_tickprefix']
    ...
    def coloraxis_colorbar_tickprefix(self, value):
        ...
        self._parameters['coloraxis_colorbar_tickprefix'] = value            
    ...
    def coloraxis_colorbar_showtickprefix(self):
        ...
        return self._parameters['coloraxis_colorbar_showtickprefix']
    ...
    def coloraxis_colorbar_showtickprefix(self, value):
        ...
        if value in valid_values:
            self._parameters['coloraxis_colorbar_showtickprefix'] = value
        else:
    ...
    def coloraxis_colorbar_ticksuffix(self):
        ...
        return self._parameters['coloraxis_colorbar_ticksuffix']
    ...
    def coloraxis_colorbar_ticksuffix(self, value):
        ...
        self._parameters['coloraxis_colorbar_ticksuffix'] = value                   
    ...
    def coloraxis_colorbar_showticksuffix(self):
        ...
        return self._parameters['coloraxis_colorbar_showticksuffix']
    ...
    def coloraxis_colorbar_showticksuffix(self, value):
        ...
        valid_values = ['all', 'first', 'last', 'none']
        if value in valid_values:
            self._parameters['coloraxis_colorbar_showticksuffix'] = value
        else:
...
class CanvasColorAxisBarTickFont(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['coloraxis_colorbar_tickfont_family'] = None
        self._parameters['coloraxis_colorbar_tickfont_size'] = 1
        self._parameters['coloraxis_colorbar_tickfont_color'] = None
        
    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['coloraxis_colorbar_tickfont_family'] = self.DEFAULTS["coloraxis_colorbar_tickfont_family"]
        self._parameters['coloraxis_colorbar_tickfont_size'] = self.DEFAULTS["coloraxis_colorbar_tickfont_size"]
        self._parameters['coloraxis_colorbar_tickfont_color'] = self.DEFAULTS["coloraxis_colorbar_tickfont_color"]

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- # 
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorAxisBarTickFont self._parameters['
        ...
        fig.update_layout(
            coloraxis=dict(
                colorbar=dict(
                    tickfont=dict(
                        family= self._parameters['coloraxis_colorbar_tickfont_family'],
                        size=self._parameters['coloraxis_colorbar_tickfont_size'],
                        color=self._parameters['coloraxis_colorbar_tickfont_color']
                    )
                )
            )
        )
    ...
    def coloraxis_colorbar_tickfont_family(self):
        ...
        """
        return self._parameters['coloraxis_colorbar_tickfont_family']
    ...
    def coloraxis_colorbar_tickfont_family(self, value):
        ...
        if isinstance(value, str):        
            self._parameters['coloraxis_colorbar_tickfont_family'] = value                    
        else:
            raise TypeError("value must be a string.")
    ...
    def coloraxis_colorbar_tickfont_size(self):
        ...
        return self._parameters['coloraxis_colorbar_tickfont_size']
    ...
    def coloraxis_colorbar_tickfont_size(self, value):
        ...
        """                
        if isinstance(value, int) and value >= 1:
            self._parameters['coloraxis_colorbar_tickfont_size'] = value     
        else:
            raise ValueError("value must be an integer >= 1.")
    ...
    def coloraxis_colorbar_tickfont_color(self):
        ...
        return self._parameters['coloraxis_colorbar_tickfont_color']
    ...
    def coloraxis_colorbar_tickfont_color(self, value):
        ...
        """                
        if isinstance(value, str):
            self._parameters['coloraxis_colorbar_tickfont_color'] = value     
        else:
            raise TypeError("value must be a string.")
...
class CanvasColorAxisBarNumbers(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['coloraxis_colorbar_separatethousands'] = True
        self._parameters['coloraxis_colorbar_exponentformat'] = 'B'
        self._parameters['coloraxis_colorbar_showexponent'] = 'all'

    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['coloraxis_colorbar_separatethousands'] = self.DEFAULTS["coloraxis_colorbar_separatethousands"]
        self._parameters['coloraxis_colorbar_exponentformat'] = self.DEFAULTS["coloraxis_colorbar_exponentformat"]
        self._parameters['coloraxis_colorbar_showexponent'] = self.DEFAULTS["coloraxis_colorbar_showexponent"]

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- # 
    def update_layout(self, fig):
        """Updates the figure layout basis ColorAxisBarNumbers self._parameters['
        ...
        fig.update_layout(
            coloraxis=dict(
                colorbar=dict(
                    separatethousands=self._parameters['coloraxis_colorbar_separatethousands'],
                    exponentformat=self._parameters['coloraxis_colorbar_exponentformat'],
                    showexponent=self._parameters['coloraxis_colorbar_showexponent']
                    )
                )
            )        
    ...
    def coloraxis_colorbar_separatethousands(self):
        ...
        return self._parameters['coloraxis_colorbar_separatethousands']
    ...
    def coloraxis_colorbar_separatethousands(self, value):
        ...
        if isinstance(value, bool):
            self._parameters['coloraxis_colorbar_separatethousands'] = value
        else:
            raise TypeError("value must be a boolean, True or False.")
    ...
    def coloraxis_colorbar_exponentformat(self):
        ...
        return self._parameters['coloraxis_colorbar_exponentformat']
    ...
    def coloraxis_colorbar_exponentformat(self, value):
        ...
        if value in valid_values:            
            self._parameters['coloraxis_colorbar_exponentformat'] = value        
        else:
    ...
    def coloraxis_colorbar_showexponent(self):
        ...
        return self._parameters['coloraxis_colorbar_showexponent']
    ...
    def coloraxis_colorbar_showexponent(self, value):
        ...
        valid_values = ['all', 'first', 'last', 'none']
        if value in valid_values:            
            self._parameters['coloraxis_colorbar_showexponent'] = value        
        else:
...
class CanvasColorAxisBarTitle(CanvasComponent):
    ...
    def __init__(self):
        self._parameters = {}
        self._parameters['coloraxis_colorbar_title_text'] = ""
        self._parameters['coloraxis_colorbar_title_font_family'] = None
        self._parameters['coloraxis_colorbar_title_font_size'] = 1
        self._parameters['coloraxis_colorbar_title_font_color'] = None
        self._parameters['coloraxis_colorbar_title_side'] = 'top'


    def reset(self):
        """Sets parameters back to their defaults."""
        self._parameters = {}
        self._parameters['coloraxis_colorbar_title_text'] = self.DEFAULTS["coloraxis_colorbar_title_text"]
        self._parameters['coloraxis_colorbar_title_font_family'] = self.DEFAULTS["coloraxis_colorbar_title_font_family"]
        self._parameters['coloraxis_colorbar_title_font_size'] = self.DEFAULTS["coloraxis_colorbar_title_font_size"]
        self._parameters['coloraxis_colorbar_title_font_color'] = self.DEFAULTS["coloraxis_colorbar_title_font_color"]
        self._parameters['coloraxis_colorbar_title_side'] = self.DEFAULTS["coloraxis_colorbar_title_side"]        

    # ----------------------------------------------------------------------- #
    #                            UPDATE LAYOUT                                #
    # ----------------------------------------------------------------------- # 
    def update_layout(self, fig):
        """Updates the figure layout basis CanvasColorAxisBarTitle self._parameters['
        ...
        """ 
        #TODO: fix title side parameter
        fig.update_layout(
            coloraxis=dict(
                colorbar=dict(
                    title=dict(
                        text=self._parameters['coloraxis_colorbar_title_text'],
                        font=dict(
                            family=self._parameters['coloraxis_colorbar_title_font_family'],
                            size=self._parameters['coloraxis_colorbar_title_font_size'],
                            color=self._parameters['coloraxis_colorbar_title_font_color']
                        )
                    )
                )
            )
    ...
    def coloraxis_colorbar_title_text(self):
        ...
        return self._parameters['coloraxis_colorbar_title_text']
    ...
    def coloraxis_colorbar_title_text(self, value):
        ...
        self._parameters['coloraxis_colorbar_title_text'] = value        
    ...
    def coloraxis_colorbar_title_font_family(self):
        ...
        return self._parameters['coloraxis_colorbar_title_font_family']
    ...
    def coloraxis_colorbar_title_font_family(self, value):
        ...
        self._parameters['coloraxis_colorbar_title_font_family'] = value                  
    ...
    def coloraxis_colorbar_title_font_size(self):
        ...
        return self._parameters['coloraxis_colorbar_title_font_size']
    ...
    def coloraxis_colorbar_title_font_size(self, value):
        ...
        if isinstance(value, (int, float)) and value >= 1:
            self._parameters['coloraxis_colorbar_title_font_size'] = value          
        else:
    ...
    def coloraxis_colorbar_title_font_color(self):
        ...
        return self._parameters['coloraxis_colorbar_title_font_color']
    ...
    def coloraxis_colorbar_title_font_color(self, value):
        ...
        self._parameters['coloraxis_colorbar_title_font_color'] = value              
    ...
    def coloraxis_colorbar_title_side(self):
        ...
        return self._parameters['coloraxis_colorbar_title_side']
    ...
    def coloraxis_colorbar_title_side(self, value):
        ...
        if value in valid_values:
            self._parameters['coloraxis_colorbar_title_side'] = value              
        else:
